...
/**
 * Migrates tui-specific keys (theme, keybinds, tui) from individualagent.json files
...
async function opencodeFiles(input: { directories: string[]; cwd: string }) {
  const files = [
    ...
    ...(await Filesystem.findUp(["individualagent.json", "individualagent.jsonc"], input.cwd, undefined, { rootFirst: true })),
  ]
