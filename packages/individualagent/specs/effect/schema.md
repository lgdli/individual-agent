...
Practical reference for migrating data types in `packages/individualagent` from
...
All of `packages/individualagent/src/config/` has been migrated. Files that still
