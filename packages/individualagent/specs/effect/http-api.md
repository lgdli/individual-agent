...
8. Run `bun typecheck` from `packages/individualagent`, relevant `bun run test:ci ...` tests from `packages/individualagent`, and `./packages/sdk/js/script/build.ts` from the repo root.
