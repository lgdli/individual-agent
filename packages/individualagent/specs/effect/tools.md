...
Practical reference for the current tool-migration state in `packages/individualagent`.
...
Tool tests should use the existing Effect helpers in `packages/individualagent/test/lib/effect.ts`:
