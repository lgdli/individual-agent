...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "arch=('aarch64' 'x86_64')",
    "license=('MIT')",
    "provides=('individualagent')",
    "conflicts=('individualagent')",
    "depends=('ripgrep')",
    "",
    ...
    "",
    "package() {",
    '  install -Dm755 ./individualagent "${pkgdir}/usr/bin/individualagent"',
    "}",
    "",
  ].join("\n")

  for (const [pkg, pkgbuild] of [["individualagent-bin", binaryPkgbuild]]) {
    for (let i = 0; i < 30; i++) {
      try {
