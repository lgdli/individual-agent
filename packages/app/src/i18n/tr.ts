...
export const dict = {
  ...
  "dialog.plugins.empty": "Eklentiler individualagent.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (individualagent.json) sağlayıcı/model adlarını kontrol edin",
