export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados em individualagent.json",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (individualagent.json)",
