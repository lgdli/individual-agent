...
export const dict = {
  ...
  "dialog.plugins.empty": "In individualagent.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (individualagent.json) auf Anbieter-/Modellnamen",
