export const dict = {
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u individualagent.json",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (individualagent.json) provider/model names",
