export const dict = {
  ...
  "dialog.plugins.empty": "Plugins konfigureret i individualagent.json",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (individualagent.json) udbyder/modelnavne",
