export const dict = {
  ...
  "dialog.plugins.empty": "Плагины настроены в individualagent.json",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (individualagent.json)",
