export const dict = {
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน individualagent.json",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (individualagent.json) ชื่อผู้ให้บริการ/โมเดล",
