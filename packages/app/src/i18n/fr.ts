export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans individualagent.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (individualagent.json) pour les noms de fournisseur/modèle",
