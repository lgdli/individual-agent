export const dict = {
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w individualagent.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (individualagent.json) nazwy dostawców/modeli",
