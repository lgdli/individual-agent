...
export const dict = {
  ...
  "dialog.plugins.empty": "Plugins konfigurert i individualagent.json",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (individualagent.json)",
