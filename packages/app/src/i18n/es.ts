export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en individualagent.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (individualagent.json)",
