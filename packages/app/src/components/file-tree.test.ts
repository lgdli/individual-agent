...
beforeAll(async () => {
  ...
  mock.module("@individualagent/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@individualagent/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@individualagent/ui/icon", () => ({ Icon: () => null }))
  mock.module("@individualagent/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
